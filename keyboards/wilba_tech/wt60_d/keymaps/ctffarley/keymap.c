...
[0] = LAYOUT_all(
	...
	KC_LCTL, KC_LGUI, KC_LALT,                            SPC_L2,                             KC_RALT, KC_RGUI, MO(2),   KC_RCTL),
...
[1] = LAYOUT_all(
    ...
    CTRLESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
	KC_LSFT, KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(2),
	KC_LALT, KC_LCTL, KC_LGUI,                            SPC_L2,                             KC_RGUI, KC_RCTL, MO(2),   KC_RALT),
...
[2] = LAYOUT_all(
	...
	_______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_HOME, KC_PGUP, _______,
	_______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_END,  KC_PGDN, _______, _______,
	PDF(0),  AG_TOGG, PDF(1),                             _______,                            _______, _______, _______, _______),
